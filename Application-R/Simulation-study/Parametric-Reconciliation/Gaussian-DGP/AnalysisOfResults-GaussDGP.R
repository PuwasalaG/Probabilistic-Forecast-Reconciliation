...
DF_MultiV_Full_GausDGP_W.o_Optim <- read.csv("Without-Optimal/Results/DF_MultiV_Full_GaussianDGP.csv")[,-1]
...
DF_MultiV_Bot_GausDGP_W.o_Optim <- read.csv("Without-Optimal/Results/DF_MultiV_Bot_GaussianDGP.csv")[,-1]


DF_MultiV_Bot_GausDGP_W.o_Optim %>% 
  group_by(`F.method`, `R.method`, `Forecast.Horizon`) %>% 
  summarise(E.LS = mean(`Variogram.score`)) -> DF_MultiV_Bot_GausDGP_W.o_Optim
...
DF_MultiV_Full_GausDGP_Optim_M2 <- read.csv("OptimalG_M2/Results/DF_MultiV_Full_GaussianDGP.csv")[,-1]
...
DF_MultiV_Bot_GausDGP_Optim_M2 <- read.csv("OptimalG_M2/Results/DF_MultiV_Bot_GaussianDGP.csv")[,-1]


DF_MultiV_Bot_GausDGP_Optim_M2 %>% 
  group_by(`F.method`, `R.method`, `Forecast.Horizon`) %>% 
  summarise(E.LS = mean(`Variogram.score`)) -> DF_MultiV_Bot_GausDGP_Optim_M2

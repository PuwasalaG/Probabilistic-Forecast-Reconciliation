...
ES_reconciled_meth1_Opt.W_501_750 <- numeric(1000)
ES_reconciled_meth3_Opt.P_501_750 <- numeric(1000)
ES_reconciled_MinT.shr_501_750 <- numeric(1000)
ES_reconciled_MinT.wls_501_750 <- numeric(1000)
ES_reconciled_OLS_501_750 <- numeric(1000)
ES_unrecon_501_750 <- numeric(1000)

VS_reconciled_meth1_Opt.W_501_750 <- numeric(1000)
VS_reconciled_meth3_Opt.P_501_750 <- numeric(1000)
VS_reconciled_MinT.shr_501_750 <- numeric(1000)
VS_reconciled_MinT.wls_501_750 <- numeric(1000)
VS_reconciled_OLS_501_750 <- numeric(1000)
VS_unrecon_501_750 <- numeric(1000)
  ...
  
{
  ...
  ES_reconciled_meth1_Opt.W_501_750[j] <- Energy_score(Reconciled_meth1_Opt.W_future_paths, Rel = Testing_eval,
                                                       B = B, n = n)
  ES_reconciled_meth3_Opt.P_501_750[j] <- Energy_score(Reconciled_meth3_Opt.P_future_paths, Rel = Testing_eval,
                                                       B = B, n = n)
  ES_reconciled_MinT.shr_501_750[j] <- Energy_score(Reconciled_MinT.shr_future_paths, Rel = Testing_eval,
                                                    B = B, n = n)
  
  ES_reconciled_MinT.wls_501_750[j] <- Energy_score(Reconciled_MinT.wls_future_paths, Rel = Testing_eval,
                                                    B = B, n = n)
  ES_reconciled_OLS_501_750[j] <- Energy_score(Reconciled_OLS_future_paths, Rel = Testing_eval, B = B, n = n)
  ES_unrecon_501_750[j] <- Energy_score(Future_paths_eval, Rel = Testing_eval, B = B, n = n)
  ...
  VS_reconciled_meth1_Opt.W_501_750[j] <- Variogram_score(Reconciled_meth1_Opt.W_future_paths, rel = Testing_eval)
  VS_reconciled_meth3_Opt.P_501_750[j] <- Variogram_score(Reconciled_meth3_Opt.P_future_paths, rel = Testing_eval)
  VS_reconciled_MinT.shr_501_750[j] <- Variogram_score(Reconciled_MinT.shr_future_paths, rel = Testing_eval)
  VS_reconciled_MinT.wls_501_750[j] <- Variogram_score(Reconciled_MinT.wls_future_paths, rel = Testing_eval)
  VS_reconciled_OLS_501_750[j] <- Variogram_score(Reconciled_OLS_future_paths, rel = Testing_eval)
  VS_unrecon_501_750[j] <- Variogram_score(Future_paths_eval, rel = Testing_eval)
...
ES_501_750 <- data.frame(ES_reconciled_meth1_Opt.W_501_750, ES_reconciled_meth3_Opt.P_501_750,
                         ES_reconciled_MinT.shr_501_750, ES_reconciled_MinT.wls_501_750, ES_reconciled_OLS_501_750,
                         ES_unrecon_501_750)
write.csv(x=ES_501_750, file = "Results/ES_501-750.csv")

VS_501_750 <- data.frame(VS_reconciled_meth1_Opt.W_501_750, VS_reconciled_meth3_Opt.P_501_750, 
                         VS_reconciled_MinT.shr_501_750, VS_reconciled_MinT.wls_501_750, VS_reconciled_OLS_501_750,
                         VS_unrecon_501_750)
write.csv(x=VS_501_750, file = "Results/VS_501-750.csv")

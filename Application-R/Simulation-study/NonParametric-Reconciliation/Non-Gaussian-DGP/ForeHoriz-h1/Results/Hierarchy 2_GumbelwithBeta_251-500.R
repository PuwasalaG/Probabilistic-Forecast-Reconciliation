...
ES_reconciled_meth1_Opt.W_251_500 <- numeric(1000)
ES_reconciled_meth3_Opt.P_251_500 <- numeric(1000)
ES_reconciled_MinT.shr_251_500 <- numeric(1000)
ES_reconciled_MinT.wls_251_500 <- numeric(1000)
ES_reconciled_OLS_251_500 <- numeric(1000)
ES_unrecon_251_500 <- numeric(1000)

VS_reconciled_meth1_Opt.W_251_500 <- numeric(1000)
VS_reconciled_meth3_Opt.P_251_500 <- numeric(1000)
VS_reconciled_MinT.shr_251_500 <- numeric(1000)
VS_reconciled_MinT.wls_251_500 <- numeric(1000)
VS_reconciled_OLS_251_500 <- numeric(1000)
VS_unrecon_251_500 <- numeric(1000)
  ...
  
{
  ...
  ES_reconciled_meth1_Opt.W_251_500[j] <- Energy_score(Reconciled_meth1_Opt.W_future_paths, Rel = Testing_eval,
                                               B = B, n = n)
  ES_reconciled_meth3_Opt.P_251_500[j] <- Energy_score(Reconciled_meth3_Opt.P_future_paths, Rel = Testing_eval,
                                               B = B, n = n)
  ES_reconciled_MinT.shr_251_500[j] <- Energy_score(Reconciled_MinT.shr_future_paths, Rel = Testing_eval,
                                            B = B, n = n)
  ES_reconciled_MinT.wls_251_500[j] <- Energy_score(Reconciled_MinT.wls_future_paths, Rel = Testing_eval,
                                                    B = B, n = n)
  ES_reconciled_OLS_251_500[j] <- Energy_score(Reconciled_OLS_future_paths, Rel = Testing_eval, B = B, n = n)
  ES_unrecon_251_500[j] <- Energy_score(Future_paths_eval, Rel = Testing_eval, B = B, n = n)
  ...
  VS_reconciled_meth1_Opt.W_251_500[j] <- Variogram_score(Reconciled_meth1_Opt.W_future_paths, rel = Testing_eval)
  VS_reconciled_meth3_Opt.P_251_500[j] <- Variogram_score(Reconciled_meth3_Opt.P_future_paths, rel = Testing_eval)
  VS_reconciled_MinT.shr_251_500[j] <- Variogram_score(Reconciled_MinT.shr_future_paths, rel = Testing_eval)
  VS_reconciled_MinT.wls_251_500[j] <- Variogram_score(Reconciled_MinT.wls_future_paths, rel = Testing_eval)
  VS_reconciled_OLS_251_500[j] <- Variogram_score(Reconciled_OLS_future_paths, rel = Testing_eval)
  VS_unrecon_251_500[j] <- Variogram_score(Future_paths_eval, rel = Testing_eval)
...
ES_251_500 <- data.frame(ES_reconciled_meth1_Opt.W_251_500, ES_reconciled_meth3_Opt.P_251_500,
                       ES_reconciled_MinT.shr_251_500, ES_reconciled_MinT.wls_251_500, ES_reconciled_OLS_251_500,
                       ES_unrecon_251_500)
write.csv(x=ES_251_500, file = "Results/ES_251-500.csv")

VS_251_500 <- data.frame(VS_reconciled_meth1_Opt.W_251_500, VS_reconciled_meth3_Opt.P_251_500, 
                         VS_reconciled_MinT.shr_251_500, VS_reconciled_MinT.wls_251_500, VS_reconciled_OLS_251_500,
                         VS_unrecon_251_500)
write.csv(x=VS_251_500, file = "Results/VS_251-500.csv")

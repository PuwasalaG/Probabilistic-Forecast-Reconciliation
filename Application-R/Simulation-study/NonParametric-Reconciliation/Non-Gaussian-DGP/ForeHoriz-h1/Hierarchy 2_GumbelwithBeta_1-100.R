...
Method <- c("Method1_Opt.W", "Method3_Opt.P", "MinT.shr", "OLS", "Unreconciled")
h1 <- c(Mean_ES_reconciled_meth1_Opt.W, Mean_ES_reconciled_meth3_Opt.P, Mean_ES_reconciled_MinT.shr, 
        Mean_ES_reconciled_OLS, Mean_ES_unrecon)

...
ES_reconciled_meth1_Opt.W_751_1000 <- numeric(1000)
ES_reconciled_meth3_Opt.P_751_1000 <- numeric(1000)
ES_reconciled_MinT.shr_751_1000 <- numeric(1000)
ES_reconciled_MinT.wls_751_1000 <- numeric(1000)
ES_reconciled_OLS_751_1000 <- numeric(1000)
ES_unrecon_751_1000 <- numeric(1000)

VS_reconciled_meth1_Opt.W_751_1000 <- numeric(1000)
VS_reconciled_meth3_Opt.P_751_1000 <- numeric(1000)
VS_reconciled_MinT.shr_751_1000 <- numeric(1000)
VS_reconciled_MinT.wls_751_1000 <- numeric(1000)
VS_reconciled_OLS_751_1000 <- numeric(1000)
VS_unrecon_751_1000 <- numeric(1000)
  ...
  
{
  ...
  ES_reconciled_meth1_Opt.W_751_1000[j] <- Energy_score(Reconciled_meth1_Opt.W_future_paths, Rel = Testing_eval,
                                                       B = B, n = n)
  ES_reconciled_meth3_Opt.P_751_1000[j] <- Energy_score(Reconciled_meth3_Opt.P_future_paths, Rel = Testing_eval,
                                                       B = B, n = n)
  ES_reconciled_MinT.shr_751_1000[j] <- Energy_score(Reconciled_MinT.shr_future_paths, Rel = Testing_eval,
                                                    B = B, n = n)
  ES_reconciled_MinT.wls_751_1000[j] <- Energy_score(Reconciled_MinT.wls_future_paths, Rel = Testing_eval,
                                                     B = B, n = n)
  
  ES_reconciled_OLS_751_1000[j] <- Energy_score(Reconciled_OLS_future_paths, Rel = Testing_eval, B = B, n = n)
  ES_unrecon_751_1000[j] <- Energy_score(Future_paths_eval, Rel = Testing_eval, B = B, n = n)
  ...
  VS_reconciled_meth1_Opt.W_751_1000[j] <- Variogram_score(Reconciled_meth1_Opt.W_future_paths, rel = Testing_eval)
  VS_reconciled_meth3_Opt.P_751_1000[j] <- Variogram_score(Reconciled_meth3_Opt.P_future_paths, rel = Testing_eval)
  VS_reconciled_MinT.shr_751_1000[j] <- Variogram_score(Reconciled_MinT.shr_future_paths, rel = Testing_eval)
  VS_reconciled_MinT.wls_751_1000[j] <- Variogram_score(Reconciled_MinT.wls_future_paths, rel = Testing_eval)
  VS_reconciled_OLS_751_1000[j] <- Variogram_score(Reconciled_OLS_future_paths, rel = Testing_eval)
  VS_unrecon_751_1000[j] <- Variogram_score(Future_paths_eval, rel = Testing_eval)
...
ES_751_1000 <- data.frame(ES_reconciled_meth1_Opt.W_751_1000, ES_reconciled_meth3_Opt.P_751_1000,
                         ES_reconciled_MinT.shr_751_1000, ES_reconciled_MinT.wls_751_1000, ES_reconciled_OLS_751_1000,
                         ES_unrecon_751_1000)
write.csv(x=ES_751_1000, file = "Results/ES_751-1000.csv")

VS_751_1000 <- data.frame(VS_reconciled_meth1_Opt.W_751_1000, VS_reconciled_meth3_Opt.P_751_1000, 
                         VS_reconciled_MinT.shr_751_1000, VS_reconciled_MinT.wls_751_1000, VS_reconciled_OLS_751_1000,
                         VS_unrecon_751_1000)
write.csv(x=VS_751_1000, file = "Results/VS_751-1000.csv")

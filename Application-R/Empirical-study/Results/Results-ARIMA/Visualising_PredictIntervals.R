...
Percetile_total_OLS <- apply(Density.forecast_total.OLS, 2, quantile, 
                             probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_B_OLS <- apply(Density.forecast_B.OLS, 2, quantile, 
                         probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_C_OLS <- apply(Density.forecast_C.OLS, 2, quantile, 
                         probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_F_OLS <- apply(Density.forecast_F.OLS, 2, quantile, 
                         probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast) %>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_AD_OLS <- apply(Density.forecast_AD.OLS, 2, quantile, 
                          probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_BD_OLS <- apply(Density.forecast_BD.OLS, 2, quantile, 
                          probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_CB_OLS <- apply(Density.forecast_CB.OLS, 2, quantile, 
                          probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

Percetile_DA_OLS <- apply(Density.forecast_DA.OLS, 2, quantile, 
                          probs = c(2.5, 10, 90, 97.5)/100, na.rm = T) %>% 
  t() %>% 
  data.frame(Time_fc = Time_forecast)%>% 
  dplyr::rename("L95" = "X2.5.", "L80" = "X10.", "H80" = "X90.", "H95" = "X97.5.")

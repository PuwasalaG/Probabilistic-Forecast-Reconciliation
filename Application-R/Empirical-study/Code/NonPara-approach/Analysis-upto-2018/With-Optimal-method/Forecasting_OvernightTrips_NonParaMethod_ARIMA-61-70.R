...
for (j in 61:70) { #1:89 (To get forecasts for all H=1 to H=12)
...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_61-70.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_61-70.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_61-70.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_61-70.csv")
write.csv(DF_UniV, "Results/DF_UniV_61-70.csv")

save.image("Results/Forecasting_OvernightTrips_NonParaMethod_61-70.RData")

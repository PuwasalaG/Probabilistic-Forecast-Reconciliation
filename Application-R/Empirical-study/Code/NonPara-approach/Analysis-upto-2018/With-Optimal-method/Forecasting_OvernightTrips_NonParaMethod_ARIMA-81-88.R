...
for (j in 81:88) { #1:89 (To get forecasts for all H=1 to H=12)
...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_81-88.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_81-88.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_81-88.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_81-88.csv")
write.csv(DF_UniV, "Results/DF_UniV_81-88.csv")

save.image("Results/Forecasting_OvernightTrips_NonParaMethod_81-88.RData")

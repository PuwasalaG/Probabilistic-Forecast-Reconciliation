...
for (j in 51:60) { #1:89 (To get forecasts for all H=1 to H=12)
...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_51-60.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_51-60.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_51-60.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_51-60.csv")
write.csv(DF_UniV, "Results/DF_UniV_51-60.csv")

save.image("Results/Forecasting_OvernightTrips_NonParaMethod_51-60.RData")

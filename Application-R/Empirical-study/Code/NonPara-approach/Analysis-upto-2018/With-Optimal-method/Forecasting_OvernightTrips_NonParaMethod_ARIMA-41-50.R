...
for (j in 41:50) { #1:89 (To get forecasts for all H=1 to H=12)
...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_41-50.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_41-50.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_41-50.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_41-50.csv")
write.csv(DF_UniV, "Results/DF_UniV_41-50.csv")

save.image("Results/Forecasting_OvernightTrips_NonParaMethod_41-50.RData")

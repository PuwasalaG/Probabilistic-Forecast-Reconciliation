...
for (j in 89) { #90:100 (To get forecasts for all H=1 to H=12)
...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_89.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_89.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_89.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_89.csv")
write.csv(DF_UniV, "Results/DF_UniV_89.csv")

save.image("Results/Forecasting_OvernightTrips_NonParaMethod_89.RData")

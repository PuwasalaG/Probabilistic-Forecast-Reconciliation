...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_26-50.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_26-50.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_26-50.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_26-50.csv")
write.csv(DF_UniV, "Results/DF_UniV_26-50.csv")

save.image("Results/Forecasting_OvernightTrips_GaussMethod_26-50.RData")

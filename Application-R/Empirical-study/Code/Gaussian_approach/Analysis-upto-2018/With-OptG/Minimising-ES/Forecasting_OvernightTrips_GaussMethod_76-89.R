...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_76-89.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_76-89.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_76-89.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_76-89.csv")
write.csv(DF_UniV, "Results/DF_UniV_76-89.csv")

save.image("Results/Forecasting_OvernightTrips_GaussMethod_76-89.RData")

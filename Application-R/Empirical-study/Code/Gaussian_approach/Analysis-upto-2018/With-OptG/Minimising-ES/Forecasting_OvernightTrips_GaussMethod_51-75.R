...
write.csv(DF_MultiV_Total, "Results/DF_MultiV_Total_51-75.csv")
write.csv(DF_MultiV_States, "Results/DF_MultiV_States_51-75.csv")
write.csv(DF_MultiV_Zones, "Results/DF_MultiV_Zones_51-75.csv")
write.csv(DF_MultiV_Regions, "Results/DF_MultiV_Regions_51-75.csv")
write.csv(DF_UniV, "Results/DF_UniV_51-75.csv")

save.image("Results/Forecasting_OvernightTrips_GaussMethod_51-75.RData")

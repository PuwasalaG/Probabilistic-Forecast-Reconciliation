...
DF_MultiV_Total_1_100 <- read.csv("DF_MultiV_Total_1-100.csv")[,-1]
DF_MultiV_Total_101_152 <- read.csv("DF_MultiV_Total_101-152.csv")[,-1]

rbind(DF_MultiV_Total_1_100, DF_MultiV_Total_101_152) %>% 
  as.data.frame() -> DF_MultiV_Total
write.csv(x=DF_MultiV_Total, file = "DF_MultiV_Total.csv")

DF_MultiV_Total <- read.csv("DF_MultiV_Total.csv")[,-1]
...
DF_MultiV_States_1_100 <- read.csv("DF_MultiV_States_1-100.csv")[,-1]
DF_MultiV_States_101_152 <- read.csv("DF_MultiV_States_101-152.csv")[,-1]
...
DF_MultiV_Zones_1_100 <- read.csv("DF_MultiV_Zones_1-100.csv")[,-1]
DF_MultiV_Zones_101_152 <- read.csv("DF_MultiV_Zones_101-152.csv")[,-1]
...
DF_MultiV_Regions_1_100 <- read.csv("DF_MultiV_Regions_1-100.csv")[,-1]
DF_MultiV_Regions_101_152 <- read.csv("DF_MultiV_Regions_101-152.csv")[,-1]

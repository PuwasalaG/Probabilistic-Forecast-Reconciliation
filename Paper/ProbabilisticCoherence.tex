...
The mean energy score is summarised in Table~\ref{tab:appres}.

\begin{table}[H]

\caption{\label{tab:appes} Mean Energy Score for electricity application.  Values in bold indicate the best reconciliation method for a given base forecasting method.}

\begin{tabular}{l|r|r|r|r}
	\hline
	Method & Ind. Bootstrap & Joint Bootstrap & Ind. Gaussian & Joint Gaussian\\
	\hline
	...
	\hline
	OLS & \textbf{35.42} & \textbf{34.71} & 73.72 & \textbf{34.48}\\
	\hline
	ScoreOptE & 38.23 & 39.39 & \textbf{39.96} & 39.07\\
	\hline
\end{tabular}
\end{table}

Figure~\ref{fig:nem_app_ig} shows the Nemenyi matrix for independent Gaussian base forecasts.  Score optimisation is significantly better than all other reconciliation methods.
...
Figure~\ref{fig:nem_app_jb} shows the Nemenyi matrix for jointly bootstrapped base forecasts.  Reconciliation via OLS and WLS are significantly better than all other reconciliation methods.  Although Score optimisation does not improve upon base, the differences are not significant.

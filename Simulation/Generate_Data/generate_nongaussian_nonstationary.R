...
Vt<-rst(n = N-init, xi = 0, omega = 0.6,alpha=1.5,nu=6)
...
write.csv(wide, "../Data/nongaussian_nonstationary.csv",row.names = F)


save(AR_coef_store,MA_coef_store,order_d,file = 'model_coefficients_nn.RData')
